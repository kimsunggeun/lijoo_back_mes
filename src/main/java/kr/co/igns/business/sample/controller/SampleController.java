...
public class SampleController {
	...
	public CommonResult testCreate(@NotNull @RequestBody List<SampleVO> voList) throws Exception {
	...
	public CommonResult testTransaction(@NotNull @RequestBody List<SampleVO> voList) throws Exception {
